...
public class MainController1
{
	...
	//set alpha
		...
		for(int q=1;q<20;q++)//for separate query strings
		{
		FastaSequence fsf= new FastaSequence(args[1]+q+".txt");//query
		...
		String qId,dbId;
//		PrintStream out = new PrintStream(new FileOutputStream("outputGraph2"+args[0]+"_"+q+".txt"));
//		PrintStream out = new PrintStream(new FileOutputStream("outputGraph2Global.txt"));
//		System.setOut(out);
...
//		}
		...
		System.out.println("Size :"+fsf.getSequence(0).length());
		}
