...
import java.util.*;
	...
	public class DovetailAlignBackup {
...
//		        System.out.println(i+" "+j+" d=="+D[i][j]);
		...
		int[] a=new int[2];
		//System.out.println("length of D row");
	    a=getMaxIndexDove(D);
	...
	public static int[] getMaxIndexDove(int[ ][ ] a)
	  {
	      ...
	      int colLength=(a[rowLength].length)-1;
	      System.out.println("here:"+rowLength+" "+colLength+" "+a[rowLength][colLength]);
	      
	      //for max in last row
//         
//	      for(int col = 1; col <= colLength; col++)
//	          {
//	              if(a[rowLength][col] > maxValCol)
//	              {
//	            	  maxValCol = a[ro][col];//last column
//	                  answerArrayRow[0] = rowLength;
//	                  answerArrayRow[1] = col;
//	                  
//	              }
//	          }
//	          
...
//		      {
//		          if(a[row][colLength] > maxValRow)
//		              {
//		        	  maxValRow = a[row][colLength];
//		                  answerArrayRow[0] = row;
//		                  answerArrayRow[1] = colLength;
//		              }
//		          }
	      for(int i = 1; i <= rowLength; i++)
	          {
	              if(a[i][colLength] > maxValCol)
	              {
	            	  maxValCol = a[i][colLength];//last column
	                  answerArrayRow[0] = i;
	                  answerArrayRow[1] = colLength;
          ...
          {
              if(a[rowLength][j] > maxValCol)
              {
            	  maxValRow = a[rowLength][j];//last column
                  answerArrayRow[0] = j;
                  answerArrayRow[1] = colLength;
		    ...
		    if(maxValRow== Math.max(maxValRow, maxValCol))
